    ...
    <div className="space-y-6">
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        ...
        <p className="text-blue-800 text-sm">
          The disease prevalence and care gaps data below reflects the <strong>{archetypeData?.name || archetypeData?.archetype_name || 'archetype'}</strong> you most closely match.
        </p>
      </div>
