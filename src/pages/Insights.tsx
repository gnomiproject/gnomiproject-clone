      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className={`grid ${view === 'grid' ? 'grid-cols-1 md:grid-cols-3' : 'grid-cols-1'} gap-6`}>
          ...
          <ArchetypeCard 
            ...
            category="Family a"
            color="teal"
            description="Adept at managing clinical complexity, these are organizations that face populations with elevated risk scores and high-cost specialty conditions. They employ sophisticated care coordination."
            characteristics={[
          ...
          <ArchetypeCard 
            ...
            category="Family a"
            color="yellow"
            description="Focused on prevention and early intervention, these are organizations with younger populations, large families, and high specialty care demand. They leverage comprehensive family benefits."
            characteristics={[
